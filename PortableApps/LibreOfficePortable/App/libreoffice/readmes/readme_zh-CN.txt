...
本自述文件的最新更新请见https://www.libreoffice.org/welcome/readme.html
...
通过「文件」-「发送」-「文档作为电子邮件」或「文档作为 PDF 附件」发送文档时可能会出现问题 (程序崩溃或中止)。这是由于 Windows 系统文件「Mapi」(消息应用程序编程接口) 部分文件版本导致的问题。不幸的是，我们无法确定哪些版本有问题。有关详细信息，请访问 https://www.microsoft.com 并在知识库中搜索「mapi dll」。
